        ...
        <div class="max-w-lg bg-white rounded-lg shadow-sm p-6">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="form.phone" type="tel" class="w-full bg-white/50 border border-rose-100 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all" />
                ...
                <div>
                    ...
                    <select v-model="form.status" class="w-full bg-white/50 border border-rose-100 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all">
